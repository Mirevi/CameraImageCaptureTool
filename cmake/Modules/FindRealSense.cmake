...
FIND_PATH(REALSENSE_SDK_INCLUDE_DIR NAMES h/rs_types.h HINTS ${CURRENT_DEPS_PATH}/include)

# Look for the library path
FIND_PATH(REALSENSE_SDK_LIBRARIES_DIR NAMES realsense2.lib HINTS ${CURRENT_DEPS_PATH}/lib
																${CURRENT_DEPS_PATH}/Release
																${CURRENT_DEPS_PATH}/build/Release)

# all listed variables are TRUE
INCLUDE(FindPackageHandleStandardArgs)
FIND_PACKAGE_HANDLE_STANDARD_ARGS(RealSense DEFAULT_MSG REALSENSE_SDK_LIBRARIES_DIR REALSENSE_SDK_INCLUDE_DIR)

MARK_AS_ADVANCED(REALSENSE_SDK_LIBRARIES_DIR REALSENSE_SDK_INCLUDE_DIR)
